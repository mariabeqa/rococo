...
public class BaseGrpcTest {
    ...
    protected MuseumGrpcClient museumGrpcClient = new MuseumGrpcClient();
    protected ArtistGrpcClient artistGrpcClient = new ArtistGrpcClient();
    protected PaintingGrpcClient paintingGrpcClient = new PaintingGrpcClient();
}
